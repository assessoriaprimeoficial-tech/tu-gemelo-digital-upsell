...
export function TuGemeloDigitalPage() {
  return <main className="overflow-hidden bg-upsell-bg text-upsell-text selection:bg-upsell-blue selection:text-white">
    ...
    <section className="px-5 py-20 sm:px-6 sm:py-28"><div className="mx-auto max-w-4xl text-center"><div className="relative mx-auto grid h-56 w-56 place-items-center rounded-full border-2 border-upsell-success/40 bg-upsell-success/[0.08] text-center shadow-[0_0_90px_-20px_rgba(34,197,94,0.45)] sm:h-64 sm:w-64"><div className="absolute inset-3 rounded-full border border-dashed border-upsell-success/30" /><div className="relative"><BadgeCheck className="mx-auto h-10 w-10 text-upsell-success" /><div className="mt-1 text-6xl font-black leading-none text-white">7</div><div className="mt-1 text-xs font-black tracking-[0.24em] text-white/70">DIAS</div><div className="mt-2 text-[10px] font-black tracking-[0.2em] text-upsell-success uppercase">Garantia total</div></div></div><div className="mt-10"><div className="text-xs font-black tracking-[0.22em] text-upsell-success uppercase">GARANTIA</div><h2 className="mt-4 text-4xl font-black tracking-[-0.04em] text-white sm:text-5xl">Experimente com tranquilidade.</h2><p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-upsell-text-muted sm:text-lg">Você tem 7 dias para conhecer o método e decidir se ele é para você. Dentro do prazo, pode solicitar a garantia de acordo com as condições da plataforma de compra.</p><div className="mt-9 flex justify-center"><CTA>QUERO ACESSAR O MÉTODO</CTA></div></div></div></section>

    <section className="border-y border-white/10 bg-white/[0.02] px-5 py-20 sm:px-6 sm:py-28"><div className="mx-auto max-w-7xl"><TituloSecao etiqueta="ACESSO SIMPLES" titulo={<>Da compra à sua nova <span className="upsell-text-gradient-blue">forma de pensar com IA.</span></>} /><div className="mt-12 grid gap-4 md:grid-cols-4">{["Você realiza o pagamento", "Recebe seu acesso", "Entra no Método", "Constrói sua inteligência digital"].map((passo, index) => <div key={passo} className="rounded-[24px] border border-white/10 bg-black/20 p-6 text-center"><div className="text-xs font-black tracking-[0.2em] text-upsell-blue">0{index + 1}</div><div className="mt-4 text-lg font-black text-white">{passo}</div></div>)}</div><div className="mt-12 flex justify-center"><CTA /></div></div></section>

    <section className="px-5 py-20 sm:px-6 sm:py-28"><div className="mx-auto max-w-4xl"><TituloSecao etiqueta="PERGUNTAS FREQUENTES" titulo="Tudo o que você precisa saber antes de começar." /><div className="mt-12 space-y-3">{perguntas.map(([pergunta, resposta]) => <details key={pergunta} className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 open:bg-white/[0.05]"><summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-bold text-white"><span>{pergunta}</span><ChevronDown className="h-5 w-5 shrink-0 text-upsell-blue transition group-open:rotate-180" /></summary><p className="mt-4 pr-6 text-sm leading-7 text-upsell-text-muted sm:text-base">{resposta}</p></details>)}</div><div className="mt-10 flex justify-center"><CTA>QUERO GARANTIR MEU ACESSO AGORA</CTA></div></div></section>
