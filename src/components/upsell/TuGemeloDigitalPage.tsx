...
const individuais = [
  { name: "Tu Segundo Cerebro", capa: ofertaSegundoCerebro, icon: Lightbulb, hook: "Sua cabeça tem ideias demais e clareza de menos?", text: "Comandos mestres, prontos para copiar e aplicar dentro do ChatGPT, que ajudam você a organizar pensamentos, questionar premissas, revelar pontos cegos e transformar ideias em decisões e planos concretos.", bullets: ["Organize seu caos mental em poucos passos", "Enxergue riscos e oportunidades ocultas", "Transforme ideias em decisões e execução"], resultado: "RESULTADO: UMA INTELIGÊNCIA QUE PENSA COM VOCÊ.", cta: "QUERO ATIVAR MEU SEGUNDO CÉREBRO", href: "#oferta-segundo-cerebro" },
  { name: "Tu Gemelo Digital", capa: ofertaGemeloDigital, icon: Video, hook: "Crie uma vez. Apareça muitas vezes.", text: "Um processo rápido e surpreendentemente fácil para transformar textos em vídeos com avatar e voz — mesmo que você não goste de gravar, tenha pouco tempo ou nunca tenha editado um vídeo.", bullets: ["Crie seu avatar digital passo a passo", "Transforme roteiros em vídeos em poucos minutos", "Multiplique sua presença sem gravar todos os dias"], resultado: "RESULTADO: SUAS IDEIAS GANHAM VOZ, IMAGEM E PRESENÇA.", cta: "QUERO CRIAR MEU GÊMEO DIGITAL", href: "#oferta-gemelo" },
];
const comboItens = [
  { nome: "Tu Mente en GPT", etiqueta: "Guia 1", desc: "Personalize o ChatGPT com seu contexto", bonus: false },
  { nome: "Tu Segundo Cerebro", etiqueta: "Guia 2", desc: "Pense com mais clareza dentro do ChatGPT", bonus: false },
  { nome: "Tu Gemelo Digital", etiqueta: "Guia 3", desc: "Transforme ideias em presença digital", bonus: false },
  { nome: "El Espejo Digital", etiqueta: "Guia 4", desc: "Reflexão guiada com o apoio do ChatGPT", bonus: false },
];
...
const pilares = [
  ...
  { step: "03", name: "Tu Segundo Cerebro", tag: "PENSA", icon: Lightbulb, title: "Sua cabeça tem ideias demais e clareza de menos?", text: "Use comandos mestres prontos para copiar e aplicar dentro do ChatGPT para organizar pensamentos, desenvolver ideias, analisar decisões, encontrar pontos cegos e transformar objetivos em planos concretos.", resultado: "RESULTADO: UMA INTELIGÊNCIA QUE PENSA COM VOCÊ." },
...
const recursos = ["Perfil Mestre", "Prompt Mestre", "Comandos de Alto Valor", "Sistema de Decisões", "Planos de Ação", "Análise de Riscos", "Avatar com IA", "Voz com IA", "Roteiros para Vídeo", "Prompts de Reflexão", "Mapa de Pontos Fortes", "Perguntas de Evolução"];
const perguntas = [
