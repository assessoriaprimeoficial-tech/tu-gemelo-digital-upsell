...
export function TuGemeloDigitalPage() {
  return <main className="overflow-hidden bg-upsell-bg text-upsell-text selection:bg-upsell-blue selection:text-white">
    ...
    <section className="px-5 py-20 sm:px-6 sm:py-28"><div className="mx-auto max-w-7xl"><TituloSecao etiqueta="O RESULTADO" titulo={<>Conheça. Pense. Multiplique. Evolua.</>}>O Método Mente Expandida conecta as quatro capacidades em um único sistema para ajudar você a sair do contexto para a clareza, da clareza para a execução e da execução para uma presença que pode crescer com você.</TituloSecao><div className="mx-auto mt-12 grid max-w-5xl gap-4 md:grid-cols-4">{pilares.map((pilar) => <div key={pilar.tag} className="rounded-[24px] border border-upsell-blue/15 bg-upsell-blue/[0.06] p-6 text-center"><div className="text-[11px] font-black tracking-[0.2em] text-upsell-blue">{pilar.tag}</div><div className="mt-3 text-base font-black text-white">{pilar.name}</div></div>)}</div><div className="mt-12 flex justify-center"><CTA /></div></div></section>

    <section id="oferta" className="relative border-y border-white/10 bg-black/25 px-5 py-20 sm:px-6 sm:py-28"><div className="pointer-events-none absolute left-1/2 top-1/2 h-[520px] w-[720px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-upsell-blue/10 blur-[150px]" /><div className="relative mx-auto max-w-4xl text-center"><span className="inline-flex items-center gap-2 rounded-full border border-upsell-gold/25 bg-upsell-gold/10 px-4 py-2 text-xs font-black tracking-[0.18em] text-upsell-gold uppercase"><Sparkles className="h-4 w-4" /> Oferta especial</span><h2 className="mt-6 text-4xl font-black tracking-[-0.045em] text-white sm:text-5xl md:text-6xl">Todo o Método Mente Expandida.<span className="block text-white/45">Em um único acesso.</span></h2><div className="mx-auto mt-10 max-w-2xl rounded-[32px] border border-upsell-gold/25 bg-white/[0.045] p-6 backdrop-blur-xl sm:p-10"><div className="grid gap-3 sm:grid-cols-2">{pilares.map((pilar) => <div key={pilar.name} className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-black/25 px-4 py-3"><div className="grid h-7 w-7 shrink-0 place-items-center rounded-full bg-upsell-success/15 text-upsell-success"><Check className="h-4 w-4" /></div><span className="text-sm font-bold text-white">{pilar.name}</span></div>)}</div><div className="my-8 h-px bg-white/10" /><div className="text-xs font-black tracking-[0.22em] text-white/45 uppercase">Acesso imediato por</div><div className="mt-3 text-6xl font-black tracking-[-0.05em] text-white sm:text-7xl">US$ 9,99</div><div className="mt-2 text-sm font-bold tracking-[0.18em] text-upsell-gold uppercase">Pagamento único</div><div className="mt-8 flex justify-center"><CTA>QUERO GARANTIR MEU ACESSO AGORA</CTA></div><div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-semibold text-white/55"><span className="flex items-center gap-2"><CircleCheck className="h-4 w-4 text-upsell-success" /> Acesso digital imediato</span><span className="flex items-center gap-2"><LockKeyhole className="h-4 w-4 text-upsell-success" /> Pagamento seguro</span><span className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-upsell-success" /> Garantia de 7 dias</span></div></div><p className="mt-5 text-xs leading-5 text-white/40">Valor em dólar americano. As condições finais de pagamento são confirmadas no checkout seguro.</p></div></section>
