...
const pilares = [
  { step: "01", name: "Tu Mente en GPT", tag: "CONHECE", icon: Brain, title: "A IA deixa de adivinhar e começa a conhecer você.", text: "Você cria seu Perfil Mestre e seu Prompt Mestre para transferir seu contexto, identidade, objetivos, conhecimentos e sua forma de se comunicar. Desde a primeira conversa, a IA responde como se conhecesse você há anos." },
  { step: "02", name: "Tu Segundo Cerebro", tag: "PENSA", icon: Lightbulb, title: "A IA vira sua sócia estratégica.", text: "Com comandos de alto valor, você organiza ideias, analisa decisões, descobre oportunidades escondidas, questiona suas próprias premissas e transforma objetivos vagos em planos concretos." },
  { step: "03", name: "Tu Gemelo Digital", tag: "MULTIPLICA", icon: Video, title: "Suas ideias viram voz, imagem e presença.", text: "Você cria seu avatar, sua voz, seus roteiros e seus vídeos profissionais para conteúdo, aulas e anúncios — sem depender de se gravar de novo. Enquanto você trabalha, seu gêmeo produz por você." },
  { step: "04", name: "El Espejo Digital", tag: "EVOLUI", icon: Eye, title: "A IA ajuda você a se enxergar com total clareza.", text: "Através de conversas guiadas e superprompts, você descobre seus padrões de pensamento, seus pontos fortes, suas motivações e as oportunidades que hoje não está vendo." },
];
const resultados = [
...
export function TuGemeloDigitalPage() {
  return <main className="upsell-font overflow-hidden bg-upsell-bg text-upsell-text selection:bg-upsell-blue selection:text-white">
    ...
    {/* SEÇÃO 1 — HERO */}
    <section className="relative overflow-hidden px-5 pb-12 pt-14 sm:px-6 sm:pb-16 sm:pt-20"><MatrixRain /><div className="pointer-events-none absolute left-1/2 top-0 h-[520px] w-[720px] -translate-x-1/2 rounded-full bg-upsell-blue/15 blur-[140px]" /><div className="relative mx-auto max-w-7xl"><div className="mx-auto max-w-5xl text-center"><span className="upsell-eyebrow inline-flex items-center gap-2 rounded-full border border-upsell-blue/25 bg-upsell-blue/10 px-4 py-2 text-[11px] tracking-[0.22em] text-upsell-blue uppercase sm:text-xs"><Sparkles className="h-4 w-4" /> Método Mente Expandida™</span><h1 className="mt-7 text-4xl font-bold leading-[1.05] text-white sm:text-6xl md:text-7xl">Todo mundo usa IA. Quase ninguém usa direito.<span className="upsell-text-gradient-blue block">Hoje você sai do meio da multidão.</span></h1><img src={heroCover.url} alt="Guia Tu Mente en GPT — transforme a IA em uma extensão da sua mente" className="mx-auto mt-8 w-full max-w-sm rounded-[24px] shadow-[0_30px_90px_-30px_rgba(96,165,250,0.45)] sm:max-w-md" /><p className="mx-auto mt-8 max-w-3xl text-base leading-7 text-upsell-text-muted sm:text-xl sm:leading-8">Enquanto 99% das pessoas continuam recebendo respostas genéricas, você vai construir uma inteligência artificial que <span className="font-semibold text-white">conhece você, pensa com você, cria por você e evolui ao seu lado.</span> Não é mais uma lista de prompts. É a sua vantagem injusta.</p><div className="mt-9 flex justify-center"><CTA /></div><div className="mt-5 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-semibold text-white/55 sm:text-sm"><span className="flex items-center gap-2"><CircleCheck className="h-4 w-4 text-upsell-success" /> Acesso digital imediato</span><span className="flex items-center gap-2"><LockKeyhole className="h-4 w-4 text-upsell-success" /> Pagamento 100% seguro</span><span className="flex items-center gap-2"><ShieldCheck className="h-4 w-4 text-upsell-success" /> 7 dias de garantia</span></div></div></div></section>
