...
export function TuGemeloDigitalPage() {
  return <main className="upsell-font overflow-hidden bg-upsell-bg text-upsell-text selection:bg-upsell-blue selection:text-white">
    <div className="whitespace-nowrap border-b border-red-500/40 bg-gradient-to-r from-red-700 via-red-600 to-red-700 px-3 py-2.5 text-center text-[10px] font-bold tracking-[0.14em] text-white uppercase sm:text-xs">🔥 O valor promocional pode terminar a qualquer momento</div>
